...
<table border="0">
    ...
    <td>Hi {{ ucfirst($mailData['email']) }},</td>
	</tr>
    <td>Hi {{ ucfirst($mailData['dob']) }},</td>
	</tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td>Welcome to <b><a href="https://www.jobmygoal.com/">{{ env('APP_WEBSITE') }}</a></b></td></tr>
	<tr><td>Thanks for registering with us in company account.</td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td>Regards,</td></tr>
	<tr><td>Team swarnheaerth</td></tr>
