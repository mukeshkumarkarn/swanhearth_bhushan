                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="my-input-box">
                                                    ...
                                                    <input type="text" placeholder="Display Name" value="{{ Auth::user()->name }}" name="name" class="dispName">
													<p class="dispNameError error" id="dispNameError"></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="my-input-box">
                                                    ...
                                                    <div class="form-input">
                                                        <input placeholder="Date of Birthday *" value="{{ Auth::user()->dob }}" name="dob" class="dispDob" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date" />
														<p class="DispDoberror error" id="DispDoberror"></p>
                                            ...
                                            <div class="col-md-6">
                                                <div class="my-input-box">
                                                    <label>Country</label>
                                                    <input type="text" id="country" placeholder="Country" name="country" class="country" value="{{Auth::user()->country}}" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="my-input-box">
                                                    <label>State </label>
                                                    <input type="text" id="state" placeholder="State" name="state" class="state" value="{{Auth::user()->state}}" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="my-input-box">
                                                    <label>City </label>
                                                    <input type="text" id="city" placeholder="City" name="city" value="{{Auth::user()->city}}" class="city" disabled>
                                                </div>
                                            </div>

                                            <div class="buttons  mt-4">
                                                <a class="custom-button" href="{{url('/')}}">Back</a>
                                                <button type="submit" class="main-btn update_profile">Save Changes</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
