    ...
    <div class="bz_single_product_main_wrapper w-100 float-start">
        <div class="container">
            <div class="shoping_box w-100 float-start">
                @foreach($userData as $data)<?php					$dob = new DateTime($data->dob);					$currentDate = new DateTime();					$age = $dob->diff($currentDate)->y;?>
                <div class="row">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered mb-4 my-table">
                                                        <tbody>
                                                            ...
                                                            @endif
                                                            <!-- end tr -->                                                            @if($data->dob)                                                            <tr>                                                                <th scope="row">Age</th>                                                                <td>{{$age}} Years</td>                                                            </tr>                                                            @endif                                                            @if($data->request_email_status === 2)
                                                            <tr>
