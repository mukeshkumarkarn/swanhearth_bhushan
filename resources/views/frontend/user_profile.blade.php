...
<div class="main-innerpage w-100 float-start">
    ...
    <div class="container">
        ...
        <div class="innerpages">
            ...
            <span><a href="{{('/')}}"> Home </a> &gt; <span class="font-color-pink">Matchmaking</span></span>
                        ...
                        <div class="product__carousel">
                            <div class="swiper-container gallery-top">
                                <div class="swiper-wrapper">
									@for($i=0; $i<$disp_album_count;$i++)
								
                                    <div class="swiper-slide">
                                        <a href="{{ url('assets/images'.$disp_album[$i]) }}" data-fancybox="gallery-image">
                                            <img src="{{ url('assets/images'.$disp_album[$i]) }}" alt="single-product1" class="img-fluid" />
                                        </a>
                                    </div>
									@endfor
                            ...
                            <div class="swiper-container gallery-thumbs">
                                <div class="swiper-wrapper">
									@for($i=0; $i<$disp_album_count;$i++)
										<div class="swiper-slide"> <img src="{{ url('assets/images'.$disp_album[$i]) }}" alt="single-product1" class="img-fluid"> </div>
									@endfor
                                </div>
