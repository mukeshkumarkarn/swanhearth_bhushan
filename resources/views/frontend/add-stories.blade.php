...
<div class="main-innerpage w-100 float-start">
    <div class="container">
        <div class="innerpages">
            <h2>Add stories</h2>
            <span><a href="/"> Home </a> &gt; <span class="font-color-pink">Add stories</span></span>
        </div>
    </div>
</div>
                ...
                <div class="singin-right">
                    <div class="main-form">
                        ...
                        <form method="POST" action="{{ url('story-add') }}" enctype=multipart/form-data>
                            ...
                            <br>
                            <div class="form-input">
                                <input type="text" name="summary" id="validationCustom01" placeholder="summary*" class="">
                                <label for="validationCustom01"><i class="fa fa-user"></i></label>
                            </div>
                            <br>
                            <div class="form-input">
                                <input type="text" name="details" id="validationCustom01" placeholder="details*" class="">
                                <label for="validationCustom01"><i class="fa fa-user"></i></label>
                            </div>
                            <br>
                            <div class="form-input">
