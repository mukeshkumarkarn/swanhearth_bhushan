...
<div class="main-innerpage w-100 float-start">
    <div class="container">
        <div class="innerpages">
            <h2>Email Request Send</h2>
            <span><a href="{{url('/')}}"> Home </a> &gt; <span class="font-color-pink">Email Request Send</span></span>
        </div>
    </div>
</div>
            ...
            <div class="row">
                        ...
                        <div class="pannal-box mt-0">
                            ...
                            <div class="pannal-content">
                                <ul class="nav nav-tabs profile-setting">
                                    ...
                                    <li class="nav-item"><a class="nav-link note active show" data-toggle="tab" href="#tab-18"><span><i class="fa-solid fa-check-double"></i></span> Email Request Sent<div class="note-count2">{{$sendEmailRequestsCont}}</div></a></li>
                ...
                <div class="col-lg-8 col-md-12 col-12">
                    <div class="my-profile tab-content">
                        ...
                        <div class="tab-pane active show" id="tab-18">
                            <div class="heading">
                                <h2><strong>Email Request</strong> Send</h2>
                                <div class="heart-line"> <i class="fas fa-heart"></i> </div>
                            </div>
                            <div class="gallery4-wrapper">
                                <div class="row">
                                    @if(count($sendEmailRequests) > 0)
                                    @foreach($sendEmailRequests as $sendEmailRequest)
                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                        <div class="tab_image_wrapper">
                                            <div class="tab_image">
                                                <figure>
                                                    @if($sendEmailRequest->profile_img)
                                                    <img src="{{ url('assets/images/profile_img'.'/'. $sendEmailRequest->profile_img) }}" class="img-responsive" alt="profile-img">
                                                    @else
                                            ...
                                            <div class="tab_image_text">
                                                <div class="project_title">
                                                    <h4><a href="javascript:;">{{$sendEmailRequest->name}}</a></h4>
                                                    <p> {{$sendEmailRequest->city}}, {{$sendEmailRequest->state}} </p>
                                                    <!-- <p> 85% Match </p> -->
                                                </div>
                                                <div class="req-btn-profile">
                                                    <ul class="media-list">
                                                        <li data-tooltip="Send Message"><a href="{{url('message').'/'.$sendEmailRequest->user_ref}}"><i><img src="{{asset('assets/images/icon/send-message.png')}}" alt="send-message" /></i></a></li>
                                                        <li data-tooltip="Request Email"><a href="javascript:;"><i><img src="{{asset('assets/images/icon/Request-Email.png')}}" alt="Request Email" /></i></a></li>
                                                        @if($sendEmailRequest->request_email_status===2)
                                                        <p>{{$sendEmailRequest->email}}</p>
                                                        @endif
                                                    </ul>
                                                </div>
                                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                {{ $sendEmailRequests->links('pagination::bootstrap-4') }}
                            </div>
                        </div>
