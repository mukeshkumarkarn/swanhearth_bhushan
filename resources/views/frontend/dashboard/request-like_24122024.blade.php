...
<div class="main-innerpage w-100 float-start">
    <div class="container">
        <div class="innerpages">
            <h2>Request Like Request</h2>
            <span><a href="{{url('/')}}"> Home </a> &gt; <span class="font-color-pink">Request Like Request</span></span>
        </div>
    </div>
</div>
            ...
            <div class="row">
                        ...
                        <div class="pannal-box mt-0">
                            ...
                            <div class="pannal-content">
                                <ul class="nav nav-tabs profile-setting">
                                    ...
                                    <li class="nav-item"><a class="nav-link {{ $requestLikesCount > 0 ? 'note' : '' }} active show" data-toggle="tab" href="#tab-22"><span><i class="fa-solid fa-check-double"></i></span> Like Request Received<div class="note-count2 LikeNot">{{$requestLikesCount}}</div></a></li>
                                </ul>
                            </div>
                            <h5>Requests Sent</h5>
                            <div class="pannal-content">
                ...
                <div class="col-lg-8 col-md-12 col-12">
                    <div class="my-profile tab-content">
                        ...
                        <div class="tab-pane active show" id="tab-22">
                            <div class="heading">
                                <h2><strong>Request </strong> Like</h2>
                                <div class="heart-line"> <i class="fas fa-heart"></i> </div>
                            </div>
                            <div class="gallery4-wrapper">
                                <div class="row">
                                    @if(count($requestLikes) > 0)
                                    @foreach($requestLikes as $requestLike)
                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                        <h6 class="messageShow" style="color:green;"></h6>
                                        <div class="tab_image_wrapper">
                                            <div class="tab_image">
                                                <figure>
                                                    @if($requestLike->profile_img)
                                                    <img src="{{ url('assets/images/profile_img'.'/'. $requestLike->profile_img) }}" class="img-responsive" alt="profile-img">
                                                    @else
                                            ...
                                            <div class="tab_image_text">
                                                <div class="project_title">
                                                    <h4><a href="javascript:;">{{$requestLike->name}}</a></h4>
                                                    <p> {{$requestLike->city}}, {{$requestLike->state}} </p>
                                                    <!-- <p> 85% Match </p> -->
                                                </div>
                                                ...
                                                <div class="req-btn-profile">
                                                    <ul class="media-list">
                                                        <div class="d-flex">
                                                            <li data-tooltip="Send Message"><a href="{{url('message').'/'.$requestLike->user_ref}}"><i><img src="{{asset('assets/images/icon/send-message.png')}}" alt="send-message" /></i></a></li>
                                                        </div>
                                                    </ul>
                                                </div>
                                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                {{ $requestLikes->links('pagination::bootstrap-4') }}
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        var id = $('.user_id').val();
        var url = '/api/like-request-notification-remove/' + id;
        ...
        $.ajax({
            ...
            success: function(data) {
                $('.LikeNot').css('background-color', 'white').show();
            }
        });
    });
</script>