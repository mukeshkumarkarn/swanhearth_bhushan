                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="my-input-box">
                                                    ...
                                                    <input type="text" placeholder="Last name" name="last_name" class="last-name">
                                            ...
                                            @else
                                            <input type="text" value="Admin" name="admin_employee" hidden>
                                            @endif
                                            ...
                                            <div class="col-md-6">
                                                <div class="my-input-box">
                                                    <label>Email</label>
                                                    <input type="text" placeholder="Email" class="Adminemail" name="email">
                                            ...
                                            <div class="col-md-6">
                                                <div class="my-input-box">
                                                    ...
                                                    <input type="password" placeholder=" Password" name="password" class="Adminpassword">
                                                    <h6 class="AdminPasswordError error"></h6>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="my-input-box">
                                                    <label>Confirm Password</label>
                                                    <input type="password" placeholder="Confirm New Password" name="" class="AdminConfirmPassword">
                                                    <h6 class="AdminConfirmPasswordError error"></h6>
                                                </div>
                                            </div>
                                            <div class="buttons  mt-4">
                                                <button class="custom-button" type="reset">Reset </button>
                                                <button type="button" class="main-btn AdminRegiterCheck">Submit</button>
                                                <button type="submit" class="main-btn AdminRegiterSubmit" hidden>submit</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
<script src="{{asset('assets/js/Admin-js/admin-register.js')}}"></script>
