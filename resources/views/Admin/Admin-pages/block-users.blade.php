...
<div class="main-innerpage w-100 float-start">
    <div class="container">
        <div class="innerpages">
            <h2>Blocked Users</h2>
            <span><a href="{{url('admin/all-users')}}"> Home </a> &gt; <span class="font-color-pink">Blocked Users</span></span>
        </div>
    </div>
</div>
                ...
                <div class="col-lg-8 col-md-12 col-12">
                    <div class="my-profile tab-content">
                        ...
                        <div class="tab-pane active show" id="tab-2">
                            <div class="heading">
                                <h2>Blocked <strong>Users</strong> </h2>
                                    ...
                                    <div class="col-md-12">
                                        <div class="friends-box">
                                            ...
                                            <div class="friend-name">
                                                <h4> <a href="{{url('admin/user-details') . '/' .$datas->user_ref}}">{{$datas->name}}</a>
                                                </h4>
                                                @php
                                            ...
                                            <div class="request-btn">
                                                <a href="{{url('admin-active-user') . '/' .$datas->user_ref}}" class="main-btn">Unblock</a>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
