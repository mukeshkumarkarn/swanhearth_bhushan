...
<div class="main-innerpage w-100 float-start">
    <div class="container">
        <div class="innerpages">
            <h2>Active Dating Stories</h2>
            <span><a href="{{url('admin/all-users')}}"> Home </a> &gt; <span class="font-color-pink">Active Dating Stories</span></span>
        </div>
    </div>
</div>
                ...
                <div class="col-lg-8 col-md-12 col-12">
                    <div class="my-profile tab-content">
                        ...
                        <div class="tab-pane active show" id="tab-4">
                            <div class="heading">
                                <h2> Active <strong>Dating Stories</strong></h2>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <a href="{{url('admin/dating-stories')}}" class="main-btn" style="float: right;">Back </a>
                            </div>
                            @if(session('success'))
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="blog-box text-center">
                                                    ...
                                                    <div class="buttons admin-storie">
                                                        <a href="{{url('stories-inactive') . '/' .$datas->slug}}" class="main-btn">Inactive</a>
