...
<div class="main-innerpage w-100 float-start">
    <div class="container">
        <div class="innerpages">
            <h2>Edit Stories By Admin</h2>
            <span><a href="{{url('/')}}"> Home </a> &gt; <span class="font-color-pink">Edit stories</span></span>
        </div>
    </div>
</div>
                ...
                <div class="col-lg-8 col-md-12 col-12">
                    <div class="my-profile tab-content">
                        ...
                        <div class="tab-pane active show" id="tab-5">
                            <div class="heading">
                                <h2> Edit Stories <strong>by Admin</strong></h2>
                            ...
                            <div class="input-info-box">
                                <div class="content">
                                    ...
                                    @endif
                                    <form method="POST" action="{{ url('stories-update') }}" enctype=multipart/form-data>
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="my-input-box">
                                                    <label>Home Page Upload Image (359 X 286)</label>
                                                    <ul>
                                                        <li>
                                                            <input type="file" name="home_img" class="activityPhotoUploder" value="">
                                                            @if($data->home_img)
                                                            <a href="{{url('assets/stories/home_img').'/'.$data->home_img}}" target="_blank" rel="noopener noreferrer">
                                                                <img src="{{url('assets/stories/home_img').'/'.$data->home_img}}" alt="Thumbnail" style="max-width: 100px; max-height: 100px;">
                                                            </a>
                                                            @endif
                                                        </li>
                                                    </ul>
                                            ...
                                            <div class="col-md-12">
                                                <div class="my-input-box">
                                                    <label>Listing Upload Image (416 X 331)</label>
                                                    <ul>
                                                        <li>
