...
class FrontendController extends Controller
{
    ...
    public function Home()
    {
        ...
        foreach ($pollQuestion as $pollQuestions) {
            $pollOptions = DB::table('poll_options')
                ...
                ->where('poll_options.poll_question_id', $pollQuestions->id)
    ...
    public function dashboard()
    {
        ...
        return view('frontend.dashboard', [
            ...
            'bookmarksCount' => $bookmarksCount, 'requestMobilesCount' => $requestMobilesCount, 'requestEmailsCount' => $requestEmailsCount,
            'requestLikesCount' => $requestLikesCount, 'sendMobileRequestsCount' => $sendMobileRequestsCount,
            'sendEmailRequestsCont' => $sendEmailRequestsCont, 'sendLikescount' => $sendLikescount,
        ]);
    }
    ...
    public function PermissionManage()
    {
        ...
        $FooterUser = User::where('status', 1)->orderBy('updated_at', 'desc')->limit(3)->select('name', 'profile_img','city')->get();
        $Footerstory = stories_dating::where('status', 1)->orderBy('updated_at', 'desc')
            ->limit(3)->select('title', 'slug', 'publish_date', 'listing_img')->get();
    ...
    public function friend_message()
    {
        ...
        return view('frontend.dashboard.friend-message', [
            'dynamicMeta' => $dynamicMeta, 'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'message' => $message, 'count' => $count, 'bookmarksCount' => $bookmarksCount
        ]);
    }
    ...
    public function request_mobile_recived()
    {
        ...
        return view('frontend.dashboard.request-mobile', [
            'dynamicMeta' => $dynamicMeta, 'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'requestMobiles' => $requestMobiles, 'requestMobilesCount' => $requestMobilesCount, 'bookmarksCount' => $bookmarksCount,
            'requestEmailsCount' => $requestEmailsCount, 'requestLikesCount' => $requestLikesCount,
            'sendMobileRequestsCount' => $sendMobileRequestsCount,
            'sendEmailRequestsCont' => $sendEmailRequestsCont, 'sendLikescount' => $sendLikescount
        ]);
    }
    ...
    public function request_email_recived()
    {
        ...
        return view('frontend.dashboard.request-email', [
            'dynamicMeta' => $dynamicMeta, 'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'requestEmails' => $requestEmails, 'requestEmailsCount' => $requestEmailsCount, 'bookmarksCount' => $bookmarksCount,
            'requestMobilesCount' => $requestMobilesCount, 'requestLikesCount' => $requestLikesCount, 'sendMobileRequestsCount' => $sendMobileRequestsCount,
            'sendEmailRequestsCont' => $sendEmailRequestsCont, 'sendLikescount' => $sendLikescount
        ]);
    }
    ...
    public function request_photo_recived()
    {
        ...
        return view('frontend.dashboard.request-photo', [
            'dynamicMeta' => $dynamicMeta, 'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'requestphotos' => $requestphotos, 'requestMobilesCount' => $requestMobilesCount, 'bookmarksCount' => $bookmarksCount,
            'requestEmailsCount' => $requestEmailsCount, 'requestLikesCount' => $requestLikesCount,
            'sendMobileRequestsCount' => $sendMobileRequestsCount,
            'sendEmailRequestsCont' => $sendEmailRequestsCont, 'sendLikescount' => $sendLikescount
        ]);
    ...
    public function request_mobile_send()
    {
        ...
        return view('frontend.dashboard.send-mobile', [
            'dynamicMeta' => $dynamicMeta, 'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'sendMobileRequests' => $sendMobileRequests, 'sendMobileRequestsCount' => $sendMobileRequestsCount
        ]);
    }
    ...
    public function request_email_send()
    {
        ...
        return view('frontend.dashboard.send-email', [
            'dynamicMeta' => $dynamicMeta, 'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'sendEmailRequests' => $sendEmailRequests, 'sendEmailRequestsCont' => $sendEmailRequestsCont
        ]);
    }
    ...
    public function request_send_photo()
    {
        ...
        return view('frontend.dashboard.send-photo', [
            'dynamicMeta' => $dynamicMeta, 'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'sendphotoRequests' => $sendphotoRequests, 'sendphotoRequestsCount' => $sendphotoRequestsCount
        ]);
    }
    ...
    public function request_like_recived()
    {
        ...
        return view('frontend.dashboard.request-like', [
            'dynamicMeta' => $dynamicMeta, 'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'requestLikes' => $requestLikes, 'requestLikesCount' => $requestLikesCount, 'requestEmailsCount' => $requestEmailsCount,
            'requestMobilesCount' => $requestMobilesCount, 'bookmarksCount' => $bookmarksCount, 'sendMobileRequestsCount' => $sendMobileRequestsCount,
            'sendEmailRequestsCont' => $sendEmailRequestsCont, 'sendLikescount' => $sendLikescount
        ]);
    }
    ...
    public function request_like_send()
    {
        ...
        return view('frontend.dashboard.send-like', [
            'dynamicMeta' => $dynamicMeta, 'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'FooterUser' => $FooterUser, 'Footerstory' => $Footerstory,
            'sendLikes' => $sendLikes, 'sendLikescount' => $sendLikescount
        ]);
    }
    ...
    public function SocialMediaRegister(Request $request)
    {
        ...
        $FooterUser = User::where('status', 1)->orderBy('updated_at', 'desc')->limit(3)
            ->select('name', 'profile_img','city')->get();
        $Footerstory = stories_dating::where('status', 1)->orderBy('updated_at', 'desc')
            ->limit(3)->select('title', 'slug', 'publish_date', 'listing_img')->get();
