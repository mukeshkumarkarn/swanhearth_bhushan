...
class UserRegister extends Controller
{
    ...
    public function register(Request $request)
    {
        $request->validate([
            ...
            'password' => 'required',
            'gender' => 'required',
            'profile_img' => ['file', 'mimes:jpeg,jpg,png', 'max:2048'],
        ]);
        ...
        Log::info('User Registration ',  ['name'=>$request->name, 'imgProduct'=>$imgProduct,'email'=>$request->email,'password'=>$request->password,'pincode'=>$request->pincode,'country'=>$request->country,'state'=>$request->state,'gender'=>$request->gender,'dob'=>$request->dob,'latitude'=>$request->latitude,'longitude'=>$request->longitude,'city'=>$request->city]);
        ...
        $user->current_longitute = $request->longitude;
